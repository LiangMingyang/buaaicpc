...
(function() {
  var calcAperf, calcCap, calcERank, calcEperf, calcPerAs, calcWP, calcWeight, erf, qnorm, update;
  ...
  update = function(ARank, form, n) {
    var Aperf, CAP, CF, Eperf, Erank, PerfAs, aveRating, ele, i, j, k, l, len, len1, len2, newRating, newVol, oldRating, oldVol, sum1, sum2, sum_rating, weight;
    ...
    CF = sum1 / form.length;
    sum2 = 0;
    for (l = 0, len2 = form.length; l < len2; l++) {
      ele = form[l];
    ...
    if (ARank === 1 && newRating <= oldRating) {
