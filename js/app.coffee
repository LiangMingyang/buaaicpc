...
.controller 'main', ($scope)->
  ...
  $scope.currentRanks = [[4,9,2,1,10,6,3,8,5,7,11],[2,4,3,1,10,5,6,7,8,11,9],[10,3,4,1,11,5,6,8,2,7,9],[2,6,3,1,10,4,7,8,5,9,11],[5,3,4,8,7,6,10,9,1,2,11],[2,8,4,1,11,6,5,9,3,10,7],[1,3,5,10,9,7,2,8,6,4,11],[6,1,3,2,8,5,11,9,7,4,10],[1,3,7,4,5,2,10,8,6,11,9],[2,3,6,1,9,7,5,10,8,10,4],[3,1,2,9,6,10,7,11,8,5,4],[3,6,2,4,10,5,1,11,7,9,8],[1,8,3,2,9,4,6,11,5,7,10]]

  $scope.problemCount = [80,67,74,77,53,65,64,45,67,58,53]

  $scope.trainingCount = [50,50,50,50,30,48,48,26,50,50,23]

  $scope.updatedDate = new Date("Sun Sep 18 2016 18:05:43 GMT+0800 (HKT)")
