...
.controller 'main', ($scope)->
  ...
  $scope.currentRanks = [[4,9,2,1,10,6,3,8,5,7,11],[2,4,3,1,10,5,6,7,8,11,9],[10,3,4,1,11,5,6,8,2,7,9],[2,6,3,1,10,4,7,8,5,9,11],[5,3,4,8,7,6,10,9,1,2,11],[2,8,4,1,11,6,5,9,3,10,7],[1,3,5,10,9,7,2,8,6,4,11],[6,1,3,2,8,5,11,9,7,4,10],[1,3,7,4,5,2,10,8,6,11,9],[2,3,6,1,9,7,5,10,8,10,4]]

  $scope.problemCount = [57,49,53,57,39,47,45,39,50,41,37]

  $scope.trainingCount = [24,24,24,24,18,24,24,19,24,24,13]

  $scope.updatedDate = new Date("Tue Aug 16 2016 17:11:17 GMT+0800 (中国标准时间)")
