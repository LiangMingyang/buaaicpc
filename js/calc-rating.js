...
(function() {
  var INIT_RATING, INIT_VOL, calcAperf, calcCap, calcERank, calcEperf, calcPerAs, calcWP, calcWeight, erf, qnorm, update;
  ...
  this.calc = function(results, series, num) {
  ...
  this.build = function(ranks) {
    return calc(ranks);
  };

}).call(this);

//# sourceMappingURL=calc-rating.js.map
